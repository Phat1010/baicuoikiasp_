<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buytable.aspx.cs" Inherits="WebApplication1.display.buytable" %>
 	...
 	<article class="mid">
        ...
        <section>
            <div class="left1">
                ...
                <asp:Image ID="Image1" runat="server" Height="280px" ImageUrl="~/display/image/banghehoctap.jpg" Width="282px" />

            </div>
            <div class="left2">
                <asp:Label ID="Label1"  runat="server" Text="Label">Bộ bàn ghế học tập </asp:Label>
                <br />
                <asp:Label ID="Label3"  CssClass="price" runat="server" Text="Giá: 600000 VNĐ"></asp:Label>
                 <br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLVLXDConnectionString %>" SelectCommand="SELECT [soluong] FROM [chitiethoadon]"></asp:SqlDataSource>
                <div> 
